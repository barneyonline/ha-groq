...
- Optional: `ffmpeg` on the Home Assistant host if you enable TTS audio normalization or Long TTS.
...
- Text-to-Speech: name, model, voice, optional vocal directions, optional audio normalization, optional Long TTS, and free-tier protection.
...
- Long TTS and audio normalization need `ffmpeg` and use extra CPU.
...
- TTS audio processing fails: install `ffmpeg` on the Home Assistant host or disable audio normalization and Long TTS.
